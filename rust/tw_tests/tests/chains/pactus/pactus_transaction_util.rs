...
fn test_pactus_transaction_util_calc_tx_hash() {
    ...
    let test_cases = vec![
        ...
        TestCase {
            tx_hex: bond_with_public_key_test_case::NOT_SIGNED_DATA,
            tx_id: bond_with_public_key_test_case::TX_ID,
        },
        TestCase {
            tx_hex: bond_with_public_key_test_case::NOT_SIGNED_DATA,
            tx_id: bond_with_public_key_test_case::TX_ID,
        ...
        TestCase {
            tx_hex: bond_without_public_key_test_case::NOT_SIGNED_DATA,
            tx_id: bond_without_public_key_test_case::TX_ID,
        },
        TestCase {
            tx_hex: bond_without_public_key_test_case::NOT_SIGNED_DATA,
            tx_id: bond_without_public_key_test_case::TX_ID,
